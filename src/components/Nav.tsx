  ...
  return (
    ...
    >
      ...
      <ul className="flex flex-col gap-4">
        ...
        <li className="cursor-pointer px-3 py-1.5 tracking-tight text-purple-200">
          <a>Helpdesk</a>
        </li>
        <li className="cursor-pointer px-3 py-1.5 tracking-tight text-purple-200">
          <a>Reports</a>
        ...
        <li className="cursor-pointer px-3 py-1.5 tracking-tight text-white-100 bg-purple-400 rounded-md">
          <a>Payments</a>
        </li>
        <li className="cursor-pointer px-3 py-1.5 tracking-tight text-purple-200">
          <a>Settings</a>
